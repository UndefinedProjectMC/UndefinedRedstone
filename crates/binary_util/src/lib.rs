...
//! ```
//!
//! Optionally, if you wish to remove the `ecs_macros` feature, you can add the following to your `Cargo.toml`:
//! ```toml
//! [dependencies]
...
//! **Real-levels example:**
//!
//! A more real-levels use-case of this module could be a simple pong server,
